            ...
            <div class="scroll-sidebar">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a href="{{url('/popularDestination')}}" ><span> <i class="fas fa-book-open"></i> </span><span class="hide-menu">Popular Destination</span></a></li>
                        <li> <a href="{{url('/popularPlaces')}}" ><span> <i class="fas fa-code"></i></i> </span><span class="hide-menu">Popular Place</span></a></li>
