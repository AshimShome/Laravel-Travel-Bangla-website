...
//admin panal popular Destination management

Route::get('/popularDestination','popularDestinationController@popularDestinationIndex')->middleware('loginCheck');
Route::get('/popularDestinationData','popularDestinationController@getpopularDestinationData')->middleware('loginCheck');
Route::post('/popularDestinationDetails','popularDestinationController@getpopularDestinationDetails')->middleware('loginCheck');
Route::post('/deletepopularDestinationData','popularDestinationController@deletepopularDestinationData')->middleware('loginCheck');
Route::post('/updatepopularDestinationData','popularDestinationController@updatepopularDestinationData')->middleware('loginCheck');
Route::post('/popularDestinationAdd','popularDestinationController@popularDestinationAdd')->middleware('loginCheck');


//admin panal popular place management

Route::get('/popularPlaces','popularPlacesController@popularPlacesIndex')->middleware('loginCheck');
Route::get('/getPopularPlacesData','popularPlacesController@getPopularPlacesData')->middleware('loginCheck');

Route::post('/getPopularPlacesDetails','popularPlacesController@getPopularPlacesDetails')->middleware('loginCheck');

Route::post('/deletePopularPlacesData','popularPlacesController@deletePopularPlacesData')->middleware('loginCheck');

Route::post('/updatePopularPlacesData','popularPlacesController@updatePopularPlacesData')->middleware('loginCheck');
Route::post('/PopularPlacesAdd','popularPlacesController@PopularPlacesAdd')->middleware('loginCheck');
